 ...
 */
data class LandmarkDataObject(val id: String, val hint: Int,val clue: Int,val dsc: Int, val name: Int, val latLong: LatLng)
...
internal object GeofencingConstants {
    ...
    val LANDMARK_DATA = arrayOf(
        LandmarkDataObject(
            ...
            R.string.golden_gate_bridge_clue,
            R.string.golden_gate_bridge_dsc,
        ...
        LandmarkDataObject(
            ...
            R.string.ferry_building_clue,
            R.string.ferry_building_dsc,
        ...
        LandmarkDataObject(
            ...
            R.string.pier_39_clue,
            R.string.pier_39_dsc,
        ...
        LandmarkDataObject(
           "union_square",
            ...
            R.string.union_square_clue,
            R.string.union_square_dsc,
